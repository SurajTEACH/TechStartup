...
const ProjectDetails = () => {
  return (
    <div className="bg-white dark:bg-[#0d1238] min-h-screen transition-colors duration-300  ">
      ...
      {/* HERO SECTION */}
      <section className="relative z-10 overflow-hidden pt-28 lg:pt-[150px] mx-20">
          ...
          <span className="absolute top-0 left-0 z-[-1]">
            ...
            >
              <path
                ...
                fill="url(#paint0_linear_111)"
              ></path>

              <defs>
                <linearGradient
                  id="paint0_linear_111"
                  x1="-40.5"
                  y1="117"
                  x2="301.926"
                  y2="-97.1485"
                ...
                <div className="p-6">
                  ...
                  <div className="flex gap-3">
                    ...
                    <a
                      ...
                      className="rounded-xl bg-primary px-5 py-2 text-sm font-medium text-white transition hover:opacity-90"
                    >
                      Live Demo
                    </a>
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="rounded-xl border border-gray-300 dark:border-white/20 px-5 py-2 text-sm font-medium text-black dark:text-white transition hover:bg-gray-100 dark:hover:bg-white/10"
                    >
                      Github
                    </a>
                  </div>
